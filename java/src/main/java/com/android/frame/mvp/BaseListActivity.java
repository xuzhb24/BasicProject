 ...
 */
public abstract class BaseListActivity<VB extends ViewBinding, T, V extends IBaseListView<T>, P extends BaseListPresenter<T, V>> extends BaseActivity<VB, V, P> implements
