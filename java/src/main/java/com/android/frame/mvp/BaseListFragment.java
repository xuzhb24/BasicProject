 ...
 */
public abstract class BaseListFragment<T, VB extends ViewBinding, V extends IBaseListView<T>, P extends BaseListPresenter<T, V>> extends BaseFragment<VB, V, P> implements IBaseListView<T> {
