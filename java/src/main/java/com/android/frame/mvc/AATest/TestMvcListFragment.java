 ...
 * Desc:
 */
public class TestMvcListFragment extends BaseListFragment<NewsListBean, FragmentTestMvcListBinding> {

    public static TestMvcListFragment newInstance() {
        return new TestMvcListFragment();
    }
