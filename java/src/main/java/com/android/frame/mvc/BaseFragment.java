 ...
 * Desc:基类Fragment(MVC)，和CustomObserver配合使用
 */
public abstract class BaseFragment<VB extends ViewBinding> extends Fragment implements IBaseView, OnRefreshListener {
