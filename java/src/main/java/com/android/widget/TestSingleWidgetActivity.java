...
public class TestSingleWidgetActivity extends BaseActivity_VB<ActivityTestSingleWidgetBinding> {
    ...
    public void initListener() {
        //标题栏
        binding.titleBar.setOnLeftClickListener(v -> finish());
        binding.titleBar.setOnRightClickListener(v -> ExtraUtil.alert(TestSingleWidgetActivity.this, "本页面主要是查看编写的一些单一控件的样式"));
        //加载框
