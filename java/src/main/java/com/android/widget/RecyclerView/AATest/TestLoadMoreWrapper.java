 ...
 * Desc:上拉加载更多
 */
public class TestLoadMoreWrapper extends BaseAdapter<NewsListBean.ResultBean> {

    public TestLoadMoreWrapper(Context context, List<NewsListBean.ResultBean> dataList) {
