 ...
 * Desc:头部Header
 */
public class TestHeaderAdapter extends BaseAdapter<String> {

    private List<String> mSelectedList;

    public TestHeaderAdapter(Context context, List<String> dataList, List<String> selectedList) {
    ...
    protected void bindData(ViewHolder holder, String data, int position) {
        if (position == 0) {
            holder.setText(R.id.count_tv, "已搜索到" + data + "条数据");
        } else {
